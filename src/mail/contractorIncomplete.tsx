...
export const contractorIncompleteMail = (contractor: ContractorObject | null): MailOptions => {
    return {
...
const ContractorIncomplete = (props: {contractor: ContractorObject | null}) => {
    const clientName = props.contractor ? getUserFirstName(props.contractor.user) : "";
