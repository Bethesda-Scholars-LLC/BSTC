...
export const wrongTutorToManagementMail = (job: JobObject, client: ClientObject | null, contractor: ContractorObject | null): MailOptions => {
    return {
        ...
        html: ReactDOMServer.renderToString(<WrongTutorToManagement job={job} client={client} contractor={contractor}/>)
    };
};


const WrongTutorToManagement = (props: {job: JobObject, client: ClientObject | null, contractor: ContractorObject | null}) => {
    ...
    return <p style={{margin: 0}}>
        ...
        <br/>
        <br/>
        Emails have been sent to the client and to the tutor notifying them.
        <br/>
        <br/>
