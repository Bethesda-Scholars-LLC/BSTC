...
const TutorMatched = (props: {tutor: ContractorObject, client: ClientObject | null, job: JobObject}) => {
    ...
    return <p style={{margin: 0}}>
        ...
        <ol style={smallIndent}>
            ...
            <li>
                Please review our <a href="https://sites.google.com/bethesdascholars.com/tutorresources">tutoring resources database</a> for any related resources that may be helpful for this job. It contains curriculums, practice problems, and more.
            </li>
            <li>
